...
''''''''''''''''''''''''''''''''''''''''''''''''''''''''
Public Function Base64Decode(BASE64TEXT_IN As String) As String
    ...
    Base64Decode = sOut    'return the text

End Function

Public Function Base64Encode(TEXT_IN As String) As String
    ...
    Base64Encode = sOut    'return the encoded base64 string
...
End Function
Public Function StrCount(ByVal Haystack As String, ByVal Needle As String, ByVal CaseSensitive As Boolean) As Long
'' This is just a simple function I wrote
 Dim pos As Long
 Dim i As Long
 Dim NL As Long
 Dim sType
...
sType = vbBinaryCompare
Else
sType = vbTextCompare
End If

   pos = InStr(1, Haystack, Needle, sType)
   If pos > 0 Then
   i = 1
    Do Until pos = 0
     pos = InStr(pos + NL, Haystack, Needle, sType)
     If pos > 0 Then
      i = i + 1
      Else
      Exit Do
 ...
 StrCount = i
End Function
Public Function StrRepeat(ByVal str As String, ByVal Multiplier As Long) As String
'' another function I wrote
